			...
			/*	$messages = [
				...
				$messages=[
 					...
 					'template' => [
						...
						'text' => 'EEveryday Special, Get Cash Back Up to 17%
							   Get Cash Back up to 7% when spending at 1,500 Baht or more 
							   sales slip 7% cash back for THE WISDOM card 
							   4% ash back for other K-Credit Cards',
						'actions' => [
